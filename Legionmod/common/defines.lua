...
pops = {
	...
	REDUCTION_AFTER_DEFEAT = 6, -- After a rebellion is being defeated in combat, its pop militancy will be divided by this number.
	...
	MIL_HIT_FROM_CONQUEST = 3, -- how much militancy grows in a province if taken without being core.
